...
public class MovieListFragment extends ListFragment {
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
        ...
        MovieLoadAsyncTask ct = new MovieLoadAsyncTask(getActivity(), this);
    ...
    public void onListItemClick(ListView l, View v, int position, long id) {
        ...
        Movie r = (Movie) getListAdapter().getItem(position);

        AlertDialog.Builder alertDialog = new AlertDialog.Builder(getActivity(), 0);
        alertDialog.setTitle("Movie");
        alertDialog.setMessage("Movie: " + r.getPelicula() + "\n" +
                "Duration: " + r.getDuracion() + "\n" +
                "Genre: " + r.getGenero());
